...
figma.connect(
  IconArrow,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A153&mode=dev",
  { example: () => <IconArrow /> }
);
figma.connect(
  IconBasket,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A155&mode=dev",
  { example: () => <IconBasket /> }
);
figma.connect(
  IconClose,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A151&mode=dev",
  { example: () => <IconClose /> }
);
figma.connect(
  IconDelete,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A147&mode=dev",
  { example: () => <IconDelete /> }
);
figma.connect(
  IconMenu,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A145&mode=dev",
  { example: () => <IconMenu /> }
);
figma.connect(
  IconProfile,
  "https://staging.figma.com/file/KaA4kBxUSEut1TfsH0Itmj/FOCUS%3A-Core-Library?node-id=4%3A158&mode=dev",
  { example: () => <IconProfile /> }
);
